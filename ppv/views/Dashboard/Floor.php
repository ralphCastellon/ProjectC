                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-header">
                                <h4>Control de Pisos</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <!-- /.panel-heading -->
                                    <div class="panel-body">
                                        <p>En esta pantalla encontrará los pisos creados
                                        <p>
                                        <div align="right" style="margin-top: -40px;">
                                            <a href="NewFloor.php">
                                                <i class="fa fa-user-plus fa-2x" title="Registrar un nuevo piso"></i>
                                                &nbsp;Nuevo Piso
                                            </a>
                                        </div>
                                        <div><br></div>
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th>precio</th>
                                                <th>Descripción</th>
                                                <th>Distancia del piso al colegio Montessori</th>
                                                <th>Contacto</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="text-align: center;"> <?php echo $row['n_rooms']; ?></td>
                                                <td> <?php echo $row['price']; ?></td>
                                                <td> <?php echo $row['descriptions']; ?></td>
                                                <td style="text-align: center;"> <?php echo $row['dcmkm']; ?></td>
                                        ...
                                        <form role="form" action="" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" placeholder="******"
                                                       name="pwd"
                                                       id="pwd" required/>
                                                <p style="color: gray;" class="help-block">Regla: M�nimo 6 car�cteres,
                                                    con
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" placeholder="******"
                                                       name="pwd2"
                                                       id="pwd2" required/>
                                                <p class="help-block" style="color: gray;">Regla: M�nimo 6 car�cteres,
                                                    con
                                                    letras min�sculas, may�sculas, n�meros y car�cteres especiales</p>
                                            </div>
                                            <div class="form-group">
